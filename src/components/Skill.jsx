...
const skillText = [
  {
    title: "꿈을 설계하고 디자인하다.",
    desc: "나는 공간을 만드는 것을 좋아합니다. 어렸을때부터 나만의 공간을 만드는 것을 좋아했고 나만의 다락방을 좋아했습니다. 단 한사람이라도 내가 만든 공간 속에서 영감을 받거나 마음이 움직였다면 좋겠습니다. 나만의 공간을 마음껏 만들 수 있다는건 구현(코딩)에 엄청난 매력인것 같습니다. 그 한국에서 나만의 꿈을 설계하고, 개발을 하며 앞으로 살아가고 싶습니다."
  },
  {
